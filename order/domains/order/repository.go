...
type MysqlRepository interface {
	...
	Create(ctx context.Context, tx *_repository.Use, param *_models.Order) (err error)
	Update(ctx context.Context, tx *_repository.Use, id uuid.UUID, param *_models.Order) (err error)
}
