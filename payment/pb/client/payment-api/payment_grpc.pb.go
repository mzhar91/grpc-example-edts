...
func (c *paymentServiceClient) AddPayment(ctx context.Context, in *AddPaymentRequest, opts ...grpc.CallOption) (*AddPaymentResponse, error) {
...
func (UnimplementedPaymentServiceServer) AddPayment(context.Context, *AddPaymentRequest) (*AddPaymentResponse, error) {
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "routeguide/client/payment-api/payment.proto",
}
